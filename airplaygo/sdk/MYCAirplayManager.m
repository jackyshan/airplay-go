...
- (void)netServiceBrowser:(NSNetServiceBrowser *)aNetServiceBrowser didFindService:(NSNetService *)aNetService moreComing:(BOOL)moreComing
{
    ...
    if(!moreComing)
    {
        ...
        NSLog(@"------------");
        [self.deviceList enumerateObjectsUsingBlock:^(MYCAirplayDevice * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            NSLog(@"%@", obj.displayName);
        }];
        NSLog(@"------------");
